 ...
 *
 * Just: "${PATH_TO_BINARY}/base --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class base : public RoboComp::Application
{
public:
	base (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::base::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::base app(prefix, startup_check_flag);
